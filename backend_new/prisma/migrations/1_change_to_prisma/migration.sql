...
ALTER TABLE "application_flagged_set" ADD COLUMN "rule_TEMP" VARCHAR NOT NULL DEFAULT '';
...
ALTER TABLE "application_flagged_set" ADD COLUMN "rule" "rule_enum";
...
ALTER TABLE "applications" ADD COLUMN "status_TEMP" VARCHAR;
...
ALTER TABLE "applications" ADD COLUMN "status" "application_status_enum";
...
ALTER TABLE "applications" ADD COLUMN "submission_type_TEMP" VARCHAR;
...
ALTER TABLE "applications" ADD COLUMN "submission_type" "application_submission_type_enum";
...
UPDATE "applications"
SET "review_status_TEMP" = 'duplicate' 
...
ALTER TABLE "unit_rent_types" ADD COLUMN "name_TEMP" TEXT;
...
ALTER TABLE "unit_types" ADD COLUMN "name_TEMP" TEXT;
...
ALTER TABLE "paper_applications"
DROP CONSTRAINT "paper_applications_file_id_fkey";

-- AddForeignKey

ALTER TABLE "paper_applications" ADD CONSTRAINT "paper_applications_file_id_fkey"
