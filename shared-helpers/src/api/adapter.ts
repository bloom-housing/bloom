...
const adapterFunction = async (req: NextApiRequest, res: NextApiResponse, source: string) => {
  ...
  try {
    ...
    console.error(`${source}'s backend url adapter error:`, { e })
    if (e.response) {
...
export { adapterFunction as default, adapterFunction }
