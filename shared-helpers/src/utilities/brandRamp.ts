// A mirror of api/src/utilities/brand-ramp.ts, which is the source of truth. The api cannot import
// shared-helpers, so the Partners branding form keeps its own copy to show what a ramp will derive
// to before it is saved. Change both together.
