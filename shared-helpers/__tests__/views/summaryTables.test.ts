...
describe("mergeSummaryRows & stackedUnitSummariesTable", () => {
  it("should merge units with just $ rent and no ranges", () => {
    ...
    const mergedSummaryRows = mergeSummaryRows(units)
    expect(mergedSummaryRows).toEqual({
      maxDollarRent: 1200,
      maxIncome: 150,
    ...
    expect(stackedUnitSummariesTable(units)).toEqual([
      {
