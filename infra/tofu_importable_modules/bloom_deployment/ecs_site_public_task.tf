  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        },
        {
          ...
          value = "http://bloom-api:3100"
        },
        {
          name  = "BACKEND_API_BASE_NEW"
          value = "http://bloom-api:3100"
        },
        {
          name  = "LISTINGS_QUERY"
        ...
        {
          name  = "MAX_BROWSE_LISTINGS"
          value = "10"
        },
        {
          name  = "HOUSING_COUNSELOR_SERVICE_URL"
        ...
        {
          name  = "SHOW_PUBLIC_LOTTERY"
          value = "TRUE"
        },
        {
          name  = "SHOW_MANDATED_ACCOUNTS"
          value = "FALSE"
        },
        {
          name  = "SHOW_PWDLESS"
