...
- [tofu_root_modules](./tofu_root_modules): Contains all the Open Tofu root modules. A root module
  ...
  records the results of the latest apply operation.
   ...
   - [bloom_prodlike_deployer_permission_set_policy](./tofu_root_modules/bloom_prodlike_deployer_permission_set_policy/main.tf):
     Configures the bloom-prodlike-deployer permission set policy.
