...
export const expanded = () => <ExpandableText strings={{ readMore: "More", readLess: "Less" }} expand={true}>{longText}</ExpandableText>
export const noExpansion = () => <ExpandableText strings={{ readMore: "More", readLess: "Less" }} >Short text</ExpandableText>
export const html = () => (
  <ExpandableText strings={{ readMore: "More", readLess: "Less" }} >{`Go to <a href="http://www.google.com" target="_blank">Google</a>. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been \
  the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley \
