...
| `--background-color`        | Color              | Border radius of modal, content | <Swatch colorVar="--bloom-color-white" />                 |
| `--modal-shadow`            | Box Shadow         | Border radius of modal, content | `--bloom-shadow-md`                                       |
| `--modal-border`            | Border             | Border radius of modal, content | `var(--bloom-border-1) solid var(--bloom-color-gray-400)` |
| `--footer-justify`          | Flex Justification | Border radius of modal, content | `normal`                                                  |
