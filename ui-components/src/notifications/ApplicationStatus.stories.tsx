...
days = 5
listing2.applicationOpenDate = dayjs().add(days, "days").format()
days = 10
...
days = 5
listing3.applicationOpenDate = dayjs().subtract(days, "days").format()
days = 10
...
days = 15
listing4.applicationOpenDate = dayjs().subtract(days, "days").format()
...
days = 15
listing5.applicationOpenDate = dayjs().subtract(days, "days").format()
