...
The Info Card component renders a box with a title that can be text of a link. Beneath the title is an optional subtitle. Beneath the subtitle can be a string, a component, or markdown.
