...
The media card component is used to describe the title and, optionally, subtitle of the corresponding piece of media. The header section and title of the media card is clickable and displays the media via the required handleClick prop.
...
| `--subtitle-font-size`  | Size  | The font size of the subtitle                            | `--bloom-font-size-tiny`                        |
