...
describe("<LeasingAgent>", () => {
  it("renders data if application is open", () => {
    ...
    expect(listing.leasingAgentPhone && getByText(listing.leasingAgentPhone, { exact: false })).toBeTruthy()
    expect(listing.leasingAgentOfficeHours && getByText(listing.leasingAgentOfficeHours)).toBeTruthy()
  })
  it("renders nothing if application is not open", () => {
    ...
    expect(listing.leasingAgentPhone && queryByText(listing.leasingAgentPhone, { exact: false })).toBeNull()
    expect(listing.leasingAgentOfficeHours && queryByText(listing.leasingAgentOfficeHours)).toBeNull()
  })
})
