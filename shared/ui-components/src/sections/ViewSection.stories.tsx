...
import { GridItem } from "../prototypes/GridItem"
import { ViewSection } from "./ViewSection"

export default {
  title: "Sections/View Section",
  decorators: [(storyFn: any) => <div style={{ padding: "1rem" }}>{storyFn()}</div>],
}

export const FourColumns = () => (
  <ViewSection title="Section Title" subtitle="Subsection Title" grid={true}>
    <GridItem>
...
export const TwoColumns = () => (
  <ViewSection title="Section Title" grid={true} gridColumns={2}>
    <GridItem>
      <ViewItem label="First Name" children="Lisa" />
    </GridItem>
...
export const ViewSectionSingleColumn = () => (
  <ViewSection tinted={true} insetGrid={true}>
    <div className="view-group">
...
export const ViewSectionTable = () => (
  <ViewSection title="Section Title" tinted={true} insetGrid={true}>
    <SimpleTable />
  </ViewSection>
)
