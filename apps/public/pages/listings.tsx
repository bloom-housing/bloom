...
import { groupNonReservedAndReservedSummaries } from "../lib/tableSummaries"
...
export default class extends Component<ListingsProps> {
  ...
  renderOpenListings() {
    return this.props.openListings.length > 0 ? (
      <ListingsList
        listings={this.props.openListings}
        unitSummariesTable={groupNonReservedAndReservedSummaries}
      />
    ) : (
