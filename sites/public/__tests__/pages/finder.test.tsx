...
describe("<RentalsFinder>", () => {
  ...
  it("should update content on next button click", async () => {
    ...
    expect(screen.getByRole('heading', { name: /how much rent can you afford to pay\?/i, level: 3 })).toBeInTheDocument()
    expect(screen.getByText(/we will use your selections to find you rentals that may match your housing needs./i)).toBeInTheDocument()
    ...
    expect(screen.getByRole("checkbox", { name: /include rentals that accept section 8 housing choice vouchers/i })).toBeInTheDocument()
