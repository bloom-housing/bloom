...
describe("Testing PropertyDeleteModal component", () => {
  describe("when property has associated listings", () => {
    it("should show warning modal with listings table", () => {
    ...
    it("should show multiple listings in the table", () => {
      const onClose = jest.fn()
  ...
  describe("when property has no associated listings", () => {
    it("should show delete confirmation modal", () => {
      ...
      renderWithAuth(
        <PropertyDeleteModal property={mockProperty} listings={[]} onClose={onClose} />
      )
    ...
    it("should show delete confirmation when listings exist but none are associated", () => {
      const onClose = jest.fn()
