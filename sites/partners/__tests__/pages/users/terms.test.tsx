...
describe("User Terms", () => {
  it("should render terms modal", () => {
    mockNextRouter()
    const { getByText, getByLabelText, getAllByLabelText } = render(<TermsPage />)
    ...
    const termsOfUseLink = getAllByLabelText("Terms of Use", { selector: "a" })
    expect(termsOfUseLink[0]).toBeInTheDocument()
    expect(termsOfUseLink[0]).toHaveAttribute(
      "href",
