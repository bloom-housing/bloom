describe("Listing Management Tests", () => {
  ...
  function fillOutListing(cy: Cypress.cy, listing: any): void {
    ...
    cy.getByID("whatToExpect").type("{enter}")
    cy.getByID("editor-bold").click()
    cy.getByID("whatToExpect").click()
    cy.getByID("whatToExpect").type("Item A")
    cy.getByID("whatToExpect").click()
    cy.getByID("whatToExpect").type("{enter}")
    cy.getByID("whatToExpect").click()
  ...
  function verifyDetails(cy: Cypress.cy, listing: any): void {
    ...
    cy.getByID("whatToExpect").contains("Item A")
    cy.getByID("whatToExpect").contains("Item B")
    cy.getByID("whatToExpect").contains("Item C")
    cy.contains("li", "Item A").should("exist")
    cy.contains("li", "Item B").should("exist")
    cy.contains("li", "Item C").should("exist")
