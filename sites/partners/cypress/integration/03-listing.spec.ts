describe("Listing Management Tests", () => {
  ...
  function fillOutListing(cy: Cypress.cy & EventEmitter, listing: any): void {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  function verifyDetails(cy: Cypress.cy & EventEmitter, listing: any): void {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  function verifyOpenListingWarning(cy: Cypress.cy & EventEmitter, listing: any): void {
