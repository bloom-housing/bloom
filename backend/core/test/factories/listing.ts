...
export default Factory.define<Listing>(({ sequence, factories }) => ({
  ...
  applicationDueDate: "2019-12-31T15:22:57.000-07:00", // should be date?
  applicationOpenDate: null, // nullable
  applicationFee: "30.0", // should be numeric?
  ...
  buildingSelectionCriteria: null, // nullable
  costsNotIncluded:
  ...
  depositMin: "1140.0", // should be numeric?
  depositMax: null, // should be numeric?
  developer: "Charities Housing",
  disableUnitsAccordion: true, // nullable
  imageUrl:
    "https://regional-dahlia-staging.s3-us-west-1.amazonaws.com/listings/archer/archer-studios.jpg", // nullable
  leasingAgentAddress: {
    city: `Foster City-${sequence}`,
    street: "55 Triton Park Lane",
    zipCode: "94404",
  ...
  postmarkedApplicationsReceivedByDate: "2019-12-05", // should be date?
  programRules: null, //nullable
