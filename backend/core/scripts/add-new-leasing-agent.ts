...
const adminUsername = "michalp@airnauts.com" || process.env.ADMIN_USERNAME
const adminPassword = "c9770c1bfd208b0c" || process.env.ADMIN_PASSWORD
const backendUrl = "https://proxy.housingbayarea.org/v2" || process.env.BACKEND_URL
