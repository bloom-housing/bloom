  ...
  exportListingsFromObject(listings: any[], users: any[], timeZone: string): string {
    ...
    const listingObj = listings.map((listing) => {
      ...
      return {
        ...
        "Leasing Agent State": listing.leasingAgentAddress?.state,
        ...
        "Leasing Agency Mailing Address State": listing.applicationMailingAddress?.state,
        ...
        "Leasing Agency Pickup Address State": listing.applicationPickUpAddress?.state,
