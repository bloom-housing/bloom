...
views.detail = {
  select: [
    ...
    "leasingAgents.email",
    "listingMultiselectQuestionsMultiselectQuestion.title",
    "listingMultiselectQuestionsMultiselectQuestion.subtitle",
    ...
    "listingMultiselectQuestionsMultiselectQuestion.formMetadata",
    "listings.utilities",
  ],
  leftJoins: [
