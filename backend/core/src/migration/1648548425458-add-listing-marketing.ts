...
export class addListingMarketing1648548425458 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "listings_marketing_type_enum" AS ENUM('marketing', 'comingSoon')`);
        await queryRunner.query(`ALTER TABLE "listings" ADD "marketing_type" "listings_marketing_type_enum" NOT NULL DEFAULT 'marketing'`);
