...
export class addPropertiesAndGroups1604669588916 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "property_group" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, CONSTRAINT "PK_30c4d5d238ffc95e72d94837e54" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "property_group_properties_property" ("property_group_id" uuid NOT NULL, "property_id" uuid NOT NULL, CONSTRAINT "PK_7d88a8faf587c93493dd120dd83" PRIMARY KEY ("property_group_id", "property_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_84e6a1949911510df0eff691f0" ON "property_group_properties_property" ("property_group_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_c99e75ee805d56fea44bf2970f" ON "property_group_properties_property" ("property_id") `);
