...
export class flattenPropertyIntoListing1644932339393 implements MigrationInterface {
    name = 'flattenPropertyIntoListing1644932339393'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        const listings: [{id: string, property_id: string}] = await queryRunner.query(`SELECT id, property_id FROM LISTINGS`)
        for (const l of listings) {
           await queryRunner.query(`UPDATE units SET listing_id = ($1) WHERE property_id = ($2)`, [l.id, l.property_id])
        }
        ...
        await queryRunner.query(`ALTER TABLE "property" DROP CONSTRAINT "UQ_f0f7062f34738e0b338163786fd"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        for(const l of listings) {
            const [newProperty] = await queryRunner.query(`INSERT INTO "property" (accessibility, amenities, 
                ...
                RETURNING id`,
              [l.accessibility, l.amenities, l.building_total_units, l.developer, l.household_size_max, l.household_size_min,
               l.neighborhood, l.pet_policy, l.smoking_policy, l.units_available, l.unit_amenities,
               l.services_offered, l.year_built, l.building_address_id]
            );
            await queryRunner.query(`UPDATE listings SET property_id = ($1) WHERE id = ($2)`, [newProperty.id, l.id])
            await queryRunner.query(`UPDATE units SET property_id = ($1) WHERE listing_id = ($2)`, [newProperty.id, l.id])
        }
