...
export class addListingLeasingAgent1610715331956 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "listings_leasing_agents_user_accounts" ("listings_id" uuid NOT NULL, "user_accounts_id" uuid NOT NULL, CONSTRAINT "PK_6c10161c8ebb6e0291145688c56" PRIMARY KEY ("listings_id", "user_accounts_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_f7b22af2c421e823f60c5f7d28" ON "listings_leasing_agents_user_accounts" ("listings_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_de53131bc8a08f824a5d3dd51e" ON "listings_leasing_agents_user_accounts" ("user_accounts_id") `);
