...
export class addCombinedExternalListings1684519165115 implements MigrationInterface {
  name = "addCombinedExternalListings1684519165115"

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "external_listings" ("id" uuid NOT NULL, "assets" jsonb NOT NULL, "household_size_min" integer, "household_size_max" integer, "units_available" integer, "application_due_date" TIMESTAMP WITH TIME ZONE, "application_open_date" TIMESTAMP WITH TIME ZONE, "name" text NOT NULL, "waitlist_current_size" integer, "waitlist_max_size" integer, "is_waitlist_open" boolean, "status" text NOT NULL, "review_order_type" text NOT NULL, "published_at" TIMESTAMP WITH TIME ZONE, "closed_at" TIMESTAMP WITH TIME ZONE, "updated_at" TIMESTAMP WITH TIME ZONE, "last_application_update_at" TIMESTAMP WITH TIME ZONE DEFAULT '1970-01-01', "neighborhood" text, "reserved_community_type_name" text, "url_slug" text NOT NULL, "units_summarized" jsonb, "images" jsonb, "multiselect_questions" jsonb, "jurisdiction" jsonb, "reserved_community_type" jsonb, "units" jsonb, "building_address" jsonb, "features" jsonb, "utilities" jsonb, CONSTRAINT "PK_ff07a715bb1c8a4ca5d3d35ccdc" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_c18a7b0351cd96e765e2ae461f" ON "external_listings" ("units_available") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_1bad4cf101b7b995628d306697" ON "external_listings" ("application_due_date") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_1fab4dc21264bc87b8bac44505" ON "external_listings" ("name") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_a664e117ef6f9cd89b51349399" ON "external_listings" ("is_waitlist_open") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_0d977dcc9a2f5784bf3e73463a" ON "external_listings" ("status") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_abd759d30583f6eca365a4c8a2" ON "external_listings" ("published_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_addefe299e91a21f40bd58ecfd" ON "external_listings" ("closed_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_c0283eabb306810510bd1d62f2" ON "external_listings" ("updated_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_9f7379f496658e0f9992f3421d" ON "external_listings" ("neighborhood") `
    )
    await queryRunner.query(
...
FROM "external_listings"
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listings" ALTER COLUMN "last_application_update_at" SET DEFAULT '1970-01-01 00:00:00+00'`
    )
    await queryRunner.query(
      `ALTER TABLE "listings" ALTER COLUMN "afs_last_run_at" SET DEFAULT '1970-01-01 00:00:00+00'`
    )
