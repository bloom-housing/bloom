...
export class makeApplicationPropertiesNullableForPartners1607180515097 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "alternate_contact" ALTER COLUMN "first_name" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "alternate_contact" ALTER COLUMN "last_name" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "alternate_contact" ALTER COLUMN "phone_number" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "alternate_contact" ALTER COLUMN "email_address" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "applicant" ALTER COLUMN "phone_number_type" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "demographics" ALTER COLUMN "sexual_orientation" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "first_name" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "middle_name" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "last_name" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "birth_month" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "birth_day" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "birth_year" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "email_address" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "phone_number" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "phone_number_type" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "applications" ALTER COLUMN "additional_phone_number" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "applications" ALTER COLUMN "additional_phone_number_type" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "applications" ALTER COLUMN "household_size" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "applications" ALTER COLUMN "housing_status" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "applications" ALTER COLUMN "additional_phone_number_type" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "applications" ALTER COLUMN "additional_phone_number" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "phone_number_type" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "phone_number" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "email_address" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "birth_month" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "last_name" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "middle_name" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "household_member" ALTER COLUMN "first_name" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "demographics" ALTER COLUMN "sexual_orientation" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "alternate_contact" ALTER COLUMN "email_address" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "alternate_contact" ALTER COLUMN "phone_number" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "alternate_contact" ALTER COLUMN "last_name" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "alternate_contact" ALTER COLUMN "first_name" SET NOT NULL`);
