...
export class fixIntegerTypesInListing1603449837150 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "listings" ALTER COLUMN "building_total_units" TYPE integer`);
        ...
        await queryRunner.query(`ALTER TABLE "listings" ALTER COLUMN "waitlist_current_size" TYPE integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "listings" ALTER COLUMN "waitlist_current_size" TYPE numeric`);
        ...
        await queryRunner.query(`ALTER TABLE "listings" ALTER COLUMN "building_total_units" TYPE numeric`);
    }
