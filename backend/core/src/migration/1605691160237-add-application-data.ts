...
export class addApplicationData1605691160237 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "applications" ADD "contact_preferences" text array NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "applications" ADD "send_mail_to_mailing_address" boolean NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "applications" ADD "income_period" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "applications" ADD "submission_type" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "UQ_194d0fca275b8661a56e486cb64" UNIQUE ("applicant_id")`);
        await queryRunner.query(`ALTER TABLE "applications" ADD "mailing_address_id" uuid`);
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "UQ_b72ba26ebc88981f441b30fe3c5" UNIQUE ("mailing_address_id")`);
        await queryRunner.query(`ALTER TABLE "applications" ADD "alternate_address_id" uuid`);
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "UQ_7fc41f89f22ca59ffceab5da80e" UNIQUE ("alternate_address_id")`);
        await queryRunner.query(`ALTER TABLE "applications" ADD "alternate_contact_id" uuid`);
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "UQ_56abaa378952856aaccc64d7eb3" UNIQUE ("alternate_contact_id")`);
        await queryRunner.query(`ALTER TABLE "applications" ADD "accessibility_id" uuid`);
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "UQ_3a4c71bc34dce9f6c196f110935" UNIQUE ("accessibility_id")`);
        await queryRunner.query(`ALTER TABLE "applications" ADD "demographics_id" uuid`);
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "UQ_fed5da45b7b4dafd9f025a37dd1" UNIQUE ("demographics_id")`);
        ...
        await queryRunner.query(`ALTER TABLE "household_member" ADD CONSTRAINT "FK_520996eeecf9f6fb9425dc7352c" FOREIGN KEY ("application_id") REFERENCES "applications"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "FK_194d0fca275b8661a56e486cb64" FOREIGN KEY ("applicant_id") REFERENCES "applicant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "FK_b72ba26ebc88981f441b30fe3c5" FOREIGN KEY ("mailing_address_id") REFERENCES "address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "FK_7fc41f89f22ca59ffceab5da80e" FOREIGN KEY ("alternate_address_id") REFERENCES "address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "FK_56abaa378952856aaccc64d7eb3" FOREIGN KEY ("alternate_contact_id") REFERENCES "alternate_contact"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "FK_3a4c71bc34dce9f6c196f110935" FOREIGN KEY ("accessibility_id") REFERENCES "accessibility"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "applications" ADD CONSTRAINT "FK_fed5da45b7b4dafd9f025a37dd1" FOREIGN KEY ("demographics_id") REFERENCES "demographics"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "FK_fed5da45b7b4dafd9f025a37dd1"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "FK_3a4c71bc34dce9f6c196f110935"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "FK_56abaa378952856aaccc64d7eb3"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "FK_7fc41f89f22ca59ffceab5da80e"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "FK_b72ba26ebc88981f441b30fe3c5"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "FK_194d0fca275b8661a56e486cb64"`);
        await queryRunner.query(`ALTER TABLE "household_member" DROP CONSTRAINT "FK_520996eeecf9f6fb9425dc7352c"`);
        ...
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "UQ_fed5da45b7b4dafd9f025a37dd1"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP COLUMN "demographics_id"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "UQ_3a4c71bc34dce9f6c196f110935"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP COLUMN "accessibility_id"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "UQ_56abaa378952856aaccc64d7eb3"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP COLUMN "alternate_contact_id"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "UQ_7fc41f89f22ca59ffceab5da80e"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP COLUMN "alternate_address_id"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "UQ_b72ba26ebc88981f441b30fe3c5"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP COLUMN "mailing_address_id"`);
        await queryRunner.query(`ALTER TABLE "applications" DROP CONSTRAINT "UQ_194d0fca275b8661a56e486cb64"`);
