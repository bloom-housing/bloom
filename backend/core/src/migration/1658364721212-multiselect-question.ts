...
export class multiselectQuestion1658364721212 implements MigrationInterface {
  name = "multiselectQuestion1658364721212"

  // TODO: Core test migration

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."multiselect_questions_application_section_enum" AS ENUM('program', 'preference')`
    )
    await queryRunner.query(
      `CREATE TABLE "multiselect_questions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "text" text, "sub_text" text, "description" text, "links" jsonb, "opt_out_text" text, "application_section" "public"."multiselect_questions_application_section_enum" NOT NULL, CONSTRAINT "PK_671931eccff7fb3b7cf2050cce0" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
