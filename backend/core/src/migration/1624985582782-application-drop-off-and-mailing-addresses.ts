...
export class applicationDropOffAndMailingAddresses1624985582782 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listings" ADD "application_drop_off_address_office_hours" text`
    )
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listings" DROP COLUMN "application_drop_off_address_office_hours" text`
    )
    await queryRunner.query(
      `ALTER TABLE "listings" DROP COLUMN "application_drop_off_address" jsonb`
    )
  }
}
