...
export class addLanguageToJurisdiction1634213955270 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "jurisdictions_languages_enum" AS ENUM('en', 'es', 'vi', 'zh')`);
        await queryRunner.query(`ALTER TABLE "jurisdictions" ADD "languages" "jurisdictions_languages_enum" array NOT NULL DEFAULT '{en}'`);
    }
