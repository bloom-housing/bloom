...
export class addJurisdictionalProgramEntity1633948803537 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "listing_programs" ("ordinal" integer, "page" integer, "listing_id" uuid NOT NULL, "program_id" uuid NOT NULL, CONSTRAINT "PK_84171c3ea1066baeed32822b139" PRIMARY KEY ("listing_id", "program_id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "programs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "question" text, "description" text, "subtitle" text, "subdescription" text, CONSTRAINT "PK_d43c664bcaafc0e8a06dfd34e05" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "jurisdictions_programs_programs" ("jurisdictions_id" uuid NOT NULL, "programs_id" uuid NOT NULL, CONSTRAINT "PK_5e2009964fd0aab1366091610d3" PRIMARY KEY ("jurisdictions_id", "programs_id"))`
    )
    await queryRunner.query(
